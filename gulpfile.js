...
const moveAssets = async () => {
  return gulp.src(["src/assets/images/*.svg", "src/assets/images/*.png", "src/assets/images/*.jpg", "src/assets/images/*.jpeg", "src/assets/images/*.gif", "src/assets/images/*.ico"]).pipe(gulp.dest("dist/assets/images"));
};
